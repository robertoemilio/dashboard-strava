...
def get_activities() -> list[dict]:
    ...
    #Busca todas as atividades do atleta autenticado, paginando automaticamente.
...
def get_activity_streams(activity_id: int) -> dict:
    ...
    url = f"{_STRAVA_API_BASE}/activities/{activity_id}/streams"
...
def get_activity_map(activity_id: int) -> str | None:
    ...
    # Retorna o summary_polyline de uma atividade, ou None se não disponível.
    
    url = f"{_STRAVA_API_BASE}/activities/{activity_id}"
